...
#define TX 12 // GPIO-14 (D5)
#define RX 14 // GPIO-12 (D6)
...
boolean Plugin_111(byte function, struct EventStruct *event, String& string)
{
        ...
        case PLUGIN_INIT:
        {
           ...
           if ( easySerial != nullptr ) { addLog(LOG_LEVEL_INFO, "INIT: Serial created!"); }
           else { addLog(LOG_LEVEL_INFO, "INIT: serial ERROR!"); }
        ...
        case PLUGIN_EXIT:
        {
         if (easySerial) delete easySerial;
        }
